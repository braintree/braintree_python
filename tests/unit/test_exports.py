...
class TestExports(unittest.TestCase):
    def test_exports_properties(self):
        ...
        self.assertNotEqual(braintree.BankAccountInstantVerificationGateway, None)
        self.assertNotEqual(braintree.BankAccountInstantVerificationJwt, None)
        self.assertNotEqual(braintree.BankAccountInstantVerificationJwtRequest, None)
        ...
        self.assertNotEqual(braintree.TransactionUsBankAccountRequest, None)
