...
class TestVisaCheckout(unittest.TestCase):
    def test_create_from_nonce(self):
        ...
        self.assertIsNotNone(visa_checkout_card.business)
        ...
        self.assertIsNotNone(visa_checkout_card.consumer)
        self.assertIsNotNone(visa_checkout_card.corporate)
        ...
        self.assertIsNotNone(visa_checkout_card.purchase)
    ...
    def test_create_transaction_from_nonce_and_vault(self):
        ...
        self.assertIsNotNone(visa_checkout_card_details.business)
        ...
        self.assertIsNotNone(visa_checkout_card_details.consumer)
        self.assertIsNotNone(visa_checkout_card_details.corporate)
        ...
        self.assertIsNotNone(visa_checkout_card_details.purchase)
