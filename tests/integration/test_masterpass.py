...
class TestMasterpass(unittest.TestCase):
    def test_create_from_nonce(self):
        ...
        self.assertIsNotNone(masterpass_card.business)
        ...
        self.assertIsNotNone(masterpass_card.consumer)
        self.assertIsNotNone(masterpass_card.corporate)
        ...
        self.assertIsNotNone(masterpass_card.purchase)
    ...
    def test_create_transaction_from_nonce_and_vault(self):
        ...
        self.assertIsNotNone(masterpass_card_details.business)
        ...
        self.assertIsNotNone(masterpass_card_details.consumer)
        self.assertIsNotNone(masterpass_card_details.corporate)
        ...
        self.assertIsNotNone(masterpass_card_details.purchase)
